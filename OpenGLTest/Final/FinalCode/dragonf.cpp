...
//to reposition the sun in starting position when it reaches the end
...
//glLoadIdentity();
	...
	glPushMatrix();
	glTranslatef(120,0,-310);
	dragonmodel.drawTrees3();
	glPopMatrix();

	glPushMatrix();
	glTranslatef(167,0,-315);
	dragonmodel.drawTrees3();
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-20,0,280);
	dragonmodel.drawTrees3();
	glPopMatrix();

	glPushMatrix();
	glTranslatef(160,0,390);
	dragonmodel.drawTrees();
	glPopMatrix();

	glPushMatrix();
	glTranslatef(260,0,-130);
	dragonmodel.drawTrees2();
	glPopMatrix();

	glPushMatrix();
	glTranslatef(-290,0,-50);
	dragonmodel.drawTrees4();
	glPopMatrix();
